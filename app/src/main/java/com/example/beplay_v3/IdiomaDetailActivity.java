...
public class IdiomaDetailActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_IDIOMA_ID    = "extra_idioma_id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_idioma_detail);

        tv = findViewById(R.id.tvIdiomaDetail);
        ...
        String idiomaId   = getIntent().getStringExtra(EXTRA_IDIOMA_ID);

        if (isEmpty(codPais) || isEmpty(categoryId) || isEmpty(eventId)
                || isEmpty(roomId) || isEmpty(regionId) || isEmpty(idiomaId)) {
            tv.setText("Missing codPais/categoryId/eventId/roomId/regionId/idiomaId");
            return;
        }

        // GET /idiomas/{codPais}/categoria/{idCategory}/event/{idEvent}/room/{idRoom}/region/{idRegion}/idioma/{idIdioma}
